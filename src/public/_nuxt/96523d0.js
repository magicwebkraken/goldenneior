(window.webpackJsonp = window.webpackJsonp || []).push([
  [53, 13, 14, 22, 23, 32, 35, 36, 37, 43, 44, 46, 49],
  {
    572: function (t, e, a) {
      "use strict";
      a.r(e);
                        ...
                        (t.r = new o.Rive({
                          ...
                          onLoad: function () {
                            t.resize(),
                              ...
                              t.instant
                                ? n.a.delayedCall(t.delay, function () {
                                    return t.r.play();
                                  })
                                : (t.st = n.a
                                    .timeline({
    ...
    589: function (t, e, a) {
      ...
      s.__esModule && (s = s.default),
        "string" == typeof s && (s = [[t.i, s, ""]]),
        s.locals && (t.exports = s.locals);
      (0, a(76).default)("5c4b6011", s, !0, { sourceMap: !1 });
    },
    590: function (t, e, a) {
      "use strict";
      a.r(e);
                ...
                s(
                  ...
                  [
                    s(
                      ...
                      [s("div", { staticClass: "pt-[85%] s:pt-[110%]" })]
                    ),
                    a._v(" "),
                    s(
                      "div",
                      {
                        ...
                        class: a.item.tag || a.comics ? "pt-90" : "pt-30",
                      },
                      [
                        a.item.tag || a.comics
                          ? s(
                              ...
                              [
                                s("RiveStarBubble", {
                                  attrs: {
                                    text: a.comics ? a.item.title : a.item.tag,
                                  },
                                }),
                              ],
                              1
                        ...
                        s("p", {
                          domProps: {
                            innerHTML: a._s(
                              a.$sanitize(
                                a.item.subtitle || a.truncate(a.item.text)
                              )
                            ),
                          },
                        }),
                        ...
                        a.button
                          ? s("BaseButton", {
                              staticClass: "mt-20",
                              attrs: {
                                label: a.item.link.label || "Get started",
                              },
                            })
                          : s(
                              "div",
      ...
      var s = a(7),
        ...
        r = {
          ...
          data: function () {
            return {
              opts: [
                { name: "Lorem ipsum", id: "lorem-ipsum" },
                { name: "Dolor sit", id: "dolor-sit" },
                { name: "Met consectetur", id: "Met-consectetur" },
              ],
              current: 1,
              max: 9,
            };
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 4:
                          return (
                            ...
                            (n = i.comics),
                            (l = i.total),
                            e.abrupt("return", { page: r, comics: n, total: l })
                          );
                        case 12:
                          return (
                            (e.prev = 12),
              ...
              [
                  ...
                  [
                    e(
                      "Space",
                      {
                        staticClass: "relative",
                        attrs: {
                          image: "/space/subs/comics-1.jpg",
                          "image-mobile": "/space/subs/comics-1.jp",
                        },
                      },
                ...
                e(
                  "div",
                  {
                    ref: "elems",
                    staticClass:
                      "site-max grid grid-cols-1 s:grid-cols-3 gap-y-20 s:gap-y-60 gap-x-90 relative z-2",
                  },
                  t._l(t.comics, function (a) {
                    return e("CardSmallSimple", {
                      key: a.id,
                      staticClass: "col-span-1 js-t-pop-up",
                      attrs: { item: a, button: !1, comics: !0 },
                      nativeOn: {
                        click: function (e) {
                          return t.open(a);
                        },
