(window.webpackJsonp = window.webpackJsonp || []).push([
  [51, 9, 12, 13, 22, 23, 32, 35, 36, 37, 43, 44, 49],
  {
    572: function (t, e, a) {
      "use strict";
      a.r(e);
            ...
            return e(
              ...
              [
                e(
                  ...
                  {
                    staticClass:
                      "s:p-65 flex flex-col s:flex-row s:justify-between h-trig",
                    attrs: { to: "/blog/".concat(t.item.slug) },
                  },
                  [
                    e(
                    ...
                    e(
                      ...
                      {
                        staticClass:
                          "frame-max-s bg-gradient-max-s p-20 pb-30 s:p-0 -mt-5 s:mt-0 flex-1 flex flex-col items-start w-full s:max-w-[51.5rem] s:order-1",
                      },
                      [
                        e(
                          "figure",
                        ...
                        e(
                          ...
                          {
                            staticClass:
                              "flex gap-x-15 s:gap-x-30 text-red h5 font-disp-2 mt-30",
                          },
                          [
                            t.item.date
                              ? e("span", {
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 4:
                          return (
                            ...
                            (n = i.blog),
                            (l = i.total),
                            e.abrupt("return", { page: r, blogs: n, total: l })
                          );
                        case 12:
                          return (
                            (e.prev = 12),
            ...
            return e(
              ...
              [
                ...
                e("div", { ref: "elems" }, [
                  e(
                    "section",
                    { staticClass: "site-max relative flex flex-col mb-120" },
                    [
                      e("CardFeatured", {
                        staticClass: "js-t-pop-up",
                        attrs: { item: t.page.featured },
                      }),
                      t._v(" "),
                      e(
                        "div",
                        {
                          staticClass:
                            "grid grid-cols-1 s:grid-cols-2 gap-x-95 gap-y-20 s:gap-y-90 mt-20 s:mt-90",
                        },
                        t._l(t.blogs, function (t, a) {
                          return e("CardBlog", {
                            key: a,
                            staticClass: "js-t-pop-up",
                            attrs: { item: t },
