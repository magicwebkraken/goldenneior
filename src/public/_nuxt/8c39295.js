(window.webpackJsonp = window.webpackJsonp || []).push([
  [55, 13, 22, 23, 32, 35, 36, 37, 43, 44, 49],
  {
    572: function (t, e, a) {
      "use strict";
      a.r(e);
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 4:
                          return (
                            ...
                            (n = i.gifs),
                            (l = i.total),
                            e.abrupt("return", { page: r, gifs: n, total: l })
                          );
                        case 12:
                          return (
                            (e.prev = 12),
              ...
              [
                ...
                e(
                  "div",
                  {
                    ref: "elems",
                    staticClass:
                      "site-max grid grid-cols-2 s:grid-cols-4 gap-x-10 s:gap-x-95 gap-y-20 s:gap-y-90 relative z-2",
                  },
                  t._l(t.gifs, function (a) {
                    var s;
                    return e(
                      "div",
                      {
                        key: a.id,
                        staticClass:
                          "group flex flex-col cursor-pointer js-t-pop-up",
                        on: {
                          click: function (e) {
                            return t.open(a);
                          },
                      ...
                      [
                        e(
                          ...
                          {
                            staticClass:
                              "relative media-fill frame overflow-hidden radius-fix bg-black w-full",
                          },
                          [
                            e("div", { staticClass: "pt-[100%]" }),
                            t._v(" "),
                            e("img", {
                              staticClass:
                                "has-hover:group-hover:scale-[1.05] has-hover:duration-1000 has-hover:transition-transform has-hover:ease-out-expo",
                              attrs: {
                                src:
                                  null === (s = a.gif) || void 0 === s
                                    ? void 0
                                    : s.src,
                                alt: "",
                              },
                        ...
                        e(
                          ...
                          {
                            staticClass:
                              "flex-1 frame -mt-5 bg-gradient-flipped py-10 s:py-30 px-10 s:px-25 w-full",
                          },
                          [
                            e("h3", {
                              staticClass: "h4 font-disp-2",
                              domProps: {
                                textContent: t._s(t.$sanitize(a.title)),
                              },
                            }),
                          ]
                        ),
